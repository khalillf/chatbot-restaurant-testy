...
if (isset($_POST["show_all_reservations"])) {
    ...
    $query = "SELECT * FROM dhow ORDER BY id DESC";
    ...
    $query = "SELECT * FROM dhow WHERE id = '$id' or date = '$filterDate'";
} else if (isset($_POST["show_current_day_reservations"])) {
    // Fetch reservations for the current date
    $currentDate = date("Y-m-d");
    $query = "SELECT * FROM dhow WHERE date = '$currentDate' ORDER BY id DESC";
} else {
    // Fetch reservations for the current date
    $currentDate = date("Y-m-d");
    $query = "SELECT * FROM dhow WHERE date = '$currentDate' ORDER BY id DESC";
...
<script>
    ...
    function deleteColumn(id) {
        if (confirm("Êtes-vous sûr de vouloir supprimer cette colonne ?")) {
            ...
            xhttp.open("POST", "delete_column2.php", true);
